...
<nav className="bg-white border-gray-200 ">
  ...
  <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="/logo.png" className="h-8" alt="اخبار باز" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap ">اخبار باز</span>
  </Link>
  <div className="flex md:order-2">
    ...
    <div className="relative hidden md:block">
      ...
      <input type="text" id="search-navbar" className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="جستجو..."/>
    </div>
